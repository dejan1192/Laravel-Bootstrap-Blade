...
@section('content')
 ...
 <p class="text-muted font-weight-bold col-3">by <a href='{{route('users.show', $post->user->id)}}'> {{$post->user->name}}</a>
   </p>
     ...
     <div class="card p-2 mb-2">
        ...
        <div class="row">
           <div class="col-2">
               ...
               <img style="width:50px;" class="img-fluid" src="{{ $comment->user->image->url()}}" alt="profile">
               @endif
           </div>
